...
export class SessaoQuiz {
  ...
  setEstado(e: EstadoQuiz): void { this.estado = e; }
  get estadoAtual(): string { return this.estado.nome; }
  acertar(): void { this.estado.onAcerto(this); }
  errar(): void { this.estado.onErro(this); }
  avancar(): void { this.estado.proxima(this); }
}

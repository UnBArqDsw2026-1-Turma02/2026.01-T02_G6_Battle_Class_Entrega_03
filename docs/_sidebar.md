...
- **Padrões de Projeto**
  - [<i class="fa-solid fa-shapes"></i> 3. Desenho de Software (GoF)](/PadroesDeProjeto/3.PadroesDeProjeto.md)
    - [<i class="fa-solid fa-industry"></i> 3.1. GoFs Criacionais — Factory Method](/PadroesDeProjeto/3.1.GoFsCriacionais.md)
    - [<i class="fa-solid fa-layer-group"></i> 3.2. GoFs Estruturais — Facade](/PadroesDeProjeto/3.2.GoFsEstruturais.md)
...
- **Comprobatórios**
  ...
  - [<i class="fa-solid fa-user-check"></i> João Victor Sapiência](/assets/comprovatorios/joaosapiencia/README.md)
  - [<i class="fa-solid fa-user-check"></i> Marina Agostini Galdi](/assets/comprovatorios/marina-galdi/README.md)
  - [<i class="fa-solid fa-user-check"></i> Otávio Maya](/assets/comprovatorios/otavio-maya/README.md)

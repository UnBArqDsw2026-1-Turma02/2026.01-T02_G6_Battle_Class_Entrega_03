...
| João Victor Sapiência | _sem commit registrado na E03 até o momento_ |
...
| João Victor Sapiência | _Atribuído: demos executáveis (`demo-factory`/`demo-facade`/`demo-state`) — sem commit registrado na E03 até o momento._ | A definir | — |

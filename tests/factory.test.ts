...
describe('F1 Factory Method', () => {
  ...
  it('caminho feliz: banca define formato da questao', () => {
  ...
  it('caminho feliz: RoletaCreator cria produto que alterna materias', () => {
    const roleta = new RoletaSequencialCreator([
      'historia',
      'biologia',
    ]).criarRoleta();
  ...
  it('caminho de erro: RoletaCreator rejeita lista vazia', () => {
    expect(() => new RoletaSequencialCreator([]).criarRoleta()).toThrow(
      EntradaInvalidaError,
    );
  });
